...
class AdminRouteInventoryTest {
    ...
    private static final List<Class<?>> ADMIN_CONTROLLERS = List.of(AdminController.class, AdminYamlController.class, AdminPushController.class, AdminStarsController.class, AdminInstancesController.class);
